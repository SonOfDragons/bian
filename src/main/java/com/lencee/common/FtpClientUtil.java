...
public class FtpClientUtil {
	 ...
	 * @since 1.0.0
	 */
	public static FTPClient getClient(String host, int port, String username,
	 ...
	 * @since 1.0.0
	 */
	public static void createFolder(FTPClient ftpClient, String remotePath)
			throws IOException {
	 ...
	 * @since 1.0.0
	 */
	public static boolean upload(FTPClient ftpClient, String remotePath,
			String remotFile, InputStream is) throws IOException {
		boolean flag = false;
	 ...
	 * @throws IOException
	 */
	public static boolean upload(FTPClient ftpClient, String remoteUrl,
	 ...
	 * @since 1.0.0
	 */
	public static boolean download(FTPClient ftpClient, String remotePath,
			String remoteFilename, String localPath) throws IOException {
		boolean flag = false;
		if (remotePath.length() != 0) {
			flag = ftpClient.changeWorkingDirectory(remotePath);
			if (!flag) {
	 ...
	 * @throws IOException
	 */
	public static boolean download(FTPClient ftpClient, String remoteUrl,
	 ...
	 * @since 1.0.0
	 */
	public static InputStream downloadStream(FTPClient ftpClient,
			String remotePath, String remoteFilename) throws IOException {
		InputStream is = null;
		boolean flag = false;
		if (remotePath.length() != 0) {
			flag = ftpClient.changeWorkingDirectory(remotePath);
	 ...
	 */
	public static InputStream downloadStream(FTPClient ftpClient,
			String remoteUrl) throws IOException {
		InputStream is = null;
		Map<String, String> map = splitUrl(remoteUrl);
		String remotePath = map.get("remotePath");
		String remotFile = map.get("remotFile");
